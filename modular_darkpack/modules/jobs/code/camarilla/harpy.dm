/datum/job/vampire/harpy
	...
	//known_contacts = list("Prince","Sheriff","Tremere Regent","Dealer","Emissary","Baron","Primogens") TFN EDIT REMOVE
	known_contacts = list("Prince","Sheriff","Tremere Regent","Dealer","Legate","Baron","Primogens") // TFN EDIT ADD
